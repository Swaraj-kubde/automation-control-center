      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={exportToCSV} variant="outline" size="sm" className="border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-black dark:hover:text-white hover:border-gray-400 dark:hover:border-gray-400 transition-all duration-200">
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800">
                <TableHead className="w-[100px] text-gray-900 dark:text-gray-100 hover:text-black dark:hover:text-white transition-colors duration-200">Client ID</TableHead>
                <TableHead className="w-[150px] text-gray-900 dark:text-gray-100 hover:text-black dark:hover:text-white transition-colors duration-200">Client Info</TableHead>
            ...
            <TableBody>
              {paginatedClients.map((client) => (
                <TableRow key={client.client_id} className="hover:bg-gray-100 dark:hover:bg-gray-700 border-gray-200 dark:border-gray-700 transition-all duration-200">
                  <TableCell className="hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200">
                    <div className="font-mono text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-black dark:hover:text-white transition-colors duration-200">
                      #{client.client_id}
                    </div>
                  </TableCell>
                  <TableCell className="hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200">
                    <div className="font-medium text-gray-900 dark:text-gray-100 hover:text-black dark:hover:text-white transition-colors duration-200">
                      {client.client_name}
                    </div>
                  </TableCell>
                  <TableCell className="hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200">
                    <div className="space-y-1">
                      <div className="flex items-center gap-1 text-sm text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors duration-200">
                  ...
                  <TableCell className="hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200">
                    <div className="flex items-center gap-1 text-sm">
                      ...
                      <span className="font-medium truncate max-w-[150px] text-gray-900 dark:text-gray-100 hover:text-black dark:hover:text-white transition-colors duration-200" title={client.business}>
                        {client.business || 'No business info'}
                      </span>
                    </div>
                  </TableCell>
                  <TableCell className="hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200">
                    <div className="text-sm text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors duration-200" title={client.key_challenges}>
                  ...
                  <TableCell className="hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200">
                    <div className="flex gap-1">
                      <Button 
                        ...
                        className="border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-black dark:hover:text-white hover:border-gray-400 dark:hover:border-gray-400 transition-all duration-200"
                      >
                        <Mail className="w-3 h-3" />
                      </Button>
                      <Button 
              ...
              <PaginationContent>
                <PaginationItem>
                  <PaginationPrevious 
                    ...
                    className={`${currentPage === 1 ? "pointer-events-none opacity-50" : "cursor-pointer"} text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-black dark:hover:text-white transition-all duration-200`}
                  />
                </PaginationItem>
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                  <PaginationItem key={page}>
                    <PaginationLink
                      ...
                      className={`cursor-pointer text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-black dark:hover:text-white transition-all duration-200 ${currentPage === page ? 'bg-blue-100 dark:bg-blue-800 text-blue-800 dark:text-blue-100' : ''}`}
                    >
                      {page}
                    </PaginationLink>
                  </PaginationItem>
                ...
                <PaginationItem>
                  <PaginationNext 
                    ...
                    className={`${currentPage === totalPages ? "pointer-events-none opacity-50" : "cursor-pointer"} text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-black dark:hover:text-white transition-all duration-200`}
                  />
                </PaginationItem>
              </PaginationContent>
            </Pagination>
